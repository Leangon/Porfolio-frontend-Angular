...
export class ExperienceEditComponent {
  ...
  constructor(private formBuilder: FormBuilder, private porfolioService: PorfolioService, private router: Router, private imageService: ImageService, private datePipe: DatePipe, @Inject(MAT_DIALOG_DATA) public data: Experience,  ) {
  ...
  onUpDate(event: Event, id: number){
    ...
    console.log("Estoy haciendo click en editar");
    if (this.form.valid) {
